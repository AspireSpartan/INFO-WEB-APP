<div
    ...
    @contact-us-updated.window="Object.assign(contactUsData, $event.detail)"
>
                ...
                <div class="self-stretch flex flex-col justify-start items-start gap-8">
                    ...
                    <div class="w-full md:w-72 flex flex-col justify-start items-start gap-3">
                        <div class="inline-flex justify-start items-center gap-7">
                            ...
                            <div class="self-stretch text-stone-300 text-xs font-normal font-['Source_Sans_Pro']" x-text="contactUsData.phoneNumbers"></div>
                        </div>
                        <div class="self-stretch inline-flex justify-start items-center gap-7">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            </svg>
                            <div class="self-stretch text-stone-300 text-xs font-normal font-['Source_Sans_Pro']" x-text="contactUsData.emailAddresses"></div>
                        </div>
                        <template x-if="contactUsData.contactAddress">
                            <div class="inline-flex justify-start items-start gap-7">
                                ...
                                <div class="self-stretch text-stone-300 text-xs font-normal font-['Source_Sans_Pro']" x-text="contactUsData.contactAddress"></div>
                            </div>
                        </template>
                    </div>
                </div>
