                ...
                <div class="border-b border-gray-200 pb-6 sm:pb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                <div>
                                    <label for="business_barangay" class="block text-sm font-medium text-gray-700 mb-1">Business Barangay <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="business_address" class="block text-sm font-medium text-gray-700 mb-1">Full Business Address <span class="text-red-500">*</span></label>
