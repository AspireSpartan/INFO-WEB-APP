<div class="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-white">
    <div class="bg-white p-6 sm:p-8 md:p-10 rounded-lg shadow-xl w-full max-w-4xl border border-gray-200 mt-[60px]">
        ...
        <p class="text-center text-black mb-8 sm:mb-10">Please use this form to report any concerns. Provide as much detail as possible.</p>

        <form action="#" method="POST" class="space-y-6 sm:space-y-8">
            <!-- Reporter Information Section -->
            <div class="border-b border-gray-200 pb-6 sm:pb-8">
                <h2 class="text-2xl font-semibold text-black mb-4">1. Your Information (Who)</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        <label for="reporter_name" class="block text-sm font-medium text-black mb-1">Your Full Name <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="reporter_email" class="block text-sm font-medium text-black mb-1">Email Address <span class="text-red-500">*</span></label>
                        <input type="email" id="reporter_email" name="reporter_email" required
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-black">
                    </div>
                    <div>
                        <label for="reporter_phone" class="block text-sm font-medium text-black mb-1">Phone Number</label>
                        <input type="tel" id="reporter_phone" name="reporter_phone"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-black">
                    </div>
                    <div class="md:col-span-2">
                        <label for="reporter_address" class="block text-sm font-medium text-black mb-1">Your Residential Address</label>
            ...
            <div class="border-b border-gray-200 pb-6 sm:pb-8">
                <h2 class="text-2xl font-semibold text-black mb-4">2. Concern Details (Where & When)</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        <label for="concern_date" class="block text-sm font-medium text-black mb-1">Date of Concern <span class="text-red-500">*</span></label>
                        <input type="date" id="concern_date" name="concern_date" required
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-black">
                    </div>
                    <div>
                        <label for="concern_time" class="block text-sm font-medium text-black mb-1">Time of Concern</label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-1 gap-2">
                            <select id="concern_barangay" name="concern_barangay" required
                                ...
                                <option value="Ermita">Ermani">Ermita</option>
                            ...
                            <div>
                                <label for="concern_barangay_details" class="block text-sm font-medium text-black mb-1">
                    ...
                    <div class="md:col-span-2">
                        <label for="concern_description" class="block text-sm font-medium text-black mb-1">Description of Concern <span class="text-red-500">*</span></label>
