    ...
    <div class="w-full max-w-[1428px] mx-auto mt-24 px-4 flex flex-col items-center gap-14 pb-20">
        <div class="relative w-full bg-white rounded-[20px] shadow-lg flex flex-col lg:flex-row items-center p-8 lg:p-0 min-h-[320px]">
            <div class="lg:w-2/3 p-6 order-2 lg:order-1">
                <h2 class="text-black text-3xl font-bold font-['Merriweather'] mb-4">Highway Development for Rural Connectivity</h2>
                <p class="text-neutral-600 text-xl font-['Source_Sans_Pro'] leading-relaxed">
                    <span class="text-amber-400 font-bold">Site:</span> Southern Tagalog - Eastern Mindanao Highway Segment (Phase 3)<br/>
                    <span class="text-amber-400 font-bold">Scope:</span> Construction of 30 km modern highway with bike lanes and pedestrian sidewalks.<br/>
                    <span class="text-amber-400 font-bold">Outcome:</span> Reduced travel time by 40%; improved economic access for over 120,000 residents.
                </p>
            </div>
            <div class="lg:w-1/3 flex justify-center items-center p-6 order-1 lg:order-2">
                <img class="w-[571px] h-80 rounded-[20px] object-cover shadow-[-17px_8px_18px_-1px_rgba(0,0,0,0.25)]" src="https://mycebu.ph/wp-content/uploads/2022/04/CCLEX-inauguration-banner.jpg" alt="Highway Development" />
            </div>
        </div>
        ...
        <div class="relative w-full bg-white rounded-[20px] shadow-lg flex flex-col lg:flex-row items-center p-8 lg:p-0 min-h-[320px]">
            ...
            <div class="lg:w-2/3 p-6 order-2 lg:order-2">
                <h2 class="text-black text-3xl font-bold font-['Merriweather'] mb-4">Heritage Preservation and Tourism Enhancement</h2>
                <p class="text-neutral-600 text-xl font-['Source_Sans_Pro'] leading-relaxed">
                    <span class="text-amber-400 font-bold">Site:</span> Intramuros, Manila<br/>
                    <span class="text-amber-400 font-bold">Scope:</span> Restoration of historical landmarks and public spaces including Fort Santiago and the Manila Cathedral Grounds.<br/>
                    <span class="text-amber-400 font-bold">Outcome:</span> Improved tourist footfall by 60%; boosted local microenterprises within the walled city.
                </p>
            </div>
        </div>
    </div>
