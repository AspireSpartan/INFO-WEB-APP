<div class="relative w-screen h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="navAndContent_feed mx-auto w-full max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-7xl flex items-center justify-center z-10 p-4 sm:p-6 md:p-8 flex-grow">
        <div x-data="{ showSignIn: true }" class="w-11/12 sm:w-96 max-w-sm bg-white rounded-lg shadow-lg py-8 px-6 sm:px-8 relative"
            ...
            <div x-show="showSignIn"
                ...
                <button class="w-full h-10 bg-amber-400 hover:bg-amber-500 rounded flex items-center justify-center text-white text-base font-normal mb-4 font-['Segoe_UI'] transition-all duration-300 ease-out transform hover:scale-105 hover:-translate-y-1 hover:shadow-xl active:scale-95 active:translate-y-0">
                    Sign In
                </button>

                <div class="text-gray-600 text-base font-normal font-['Segoe_UI'] mb-4 transition-all duration-300">OR</div>

                <button class="w-full h-10 bg-gray-300 hover:bg-gray-400 rounded flex items-center justify-center text-gray-800 text-base font-normal mb-6 font-['Segoe_UI'] transition-all duration-300 ease-out transform hover:scale-[1.02] hover:-translate-y-0.5 hover:shadow-lg active:scale-95">
                    Use a Sign-In Code
                </button>
            ...
            <div x-show="!showSignIn"
                ...
                <button class="w-full h-10 bg-blue-600 hover:bg-blue-700 rounded flex items-center justify-center text-white text-base font-normal mb-4 font-['Segoe_UI'] transition-all duration-300 ease-out transform hover:scale-105 hover:-translate-y-1 hover:shadow-xl active:scale-95 active:translate-y-0">
                    Sign Up
                </button>
