<div class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50"
    ...
    <div class="bg-white rounded-lg shadow-xl p-8 max-w-lg w-full mx-4"
        ...
        <form method="POST" action="{{ route('news-items.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="url" id="url" name="url" class="shadow border rounded w-full py-2 px-3" placeholder="Enter URL" />
            </div>
            <div class="mb-4">
